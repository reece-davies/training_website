    ...
    <div class="limiter">
		<div class="container-login101">
			<div class="wrap-login101 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login101-form validate-form flex-sb flex-w" action="php/alter-circuit-rounds.inc.php" method="post">
					...
					<?php 
						...
						else
						{
							...
							{
								$circuitRounds = $row["circuit_sets"];
							...
							<div class="wrap-input101 validate-input m-b-36" data-validate = "Circuit rounds is required">
								<input class="input101" type="text" name="circRounds" value="'.  $circuitRounds .'">
								<span class="focus-input101"></span>
							</div>';
							}
						}
					...
					<div class="container-login101-form-btn">
						<button class="login101-form-btn" type="submit" name="alter-circuit-rounds-submit">
							Change
						</button>
					</div>
